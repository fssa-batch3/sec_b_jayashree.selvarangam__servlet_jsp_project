...
<a style="color:black;"href="LoginNew"><button class="btn">Login</button></a>
</header>
 <% } else { %> 
...
<div class="icons">
<a href="<%=request.getContextPath() %>/add_to_cart_servlet" id="e"class="fas fa-shopping-cart"></a>
<div class="dropdown1">
<a href="#" class="fas fa-user"></a>
<div class="dropdown-content1">
   <a href="<%= request.getContextPath() %>/get_profile">profile</a>
   <a href="<%= request.getContextPath() %>/address_profile">Address profile</a>
